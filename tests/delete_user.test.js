...
describe("Delete Account", () => {
    ...
    test('create user account', async()=>{
        ...
        await page.screenshot({path: './tests/img/delete_user/sign_up.png'});
        await page.evaluate( () => {
            Array
    ...
    test('delete user', async () => {
        ...
        await page.screenshot({path: './tests/img/delete_user/delete.png'});
    }, timeout);
    ...
    test('se deconnecter du compte admin', async () => {
        ...
        await page.waitForSelector('.dropdown-menu');
        await page.screenshot({path: './tests/img/delete_user/avant_logout_admin.png'});
        await page.evaluate( () => {
            Array
            .from( document.querySelectorAll('.dropdown-menu li a'))
        ...
        await page.screenshot({path: './tests/img/delete_user/logout_admin.png'});
